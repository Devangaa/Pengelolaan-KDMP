        ...
        <div class="rounded-2xl border border-red-100 bg-white p-4 shadow-sm sm:p-6">
            <div class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        <input id="productSearch" data-product-search type="text" value="<?= esc($searchKeyword ?? '') ?>" placeholder="Cari nama produk..." class="w-full rounded-xl border border-stone-200 bg-stone-50 px-4 py-2.5 pr-10 text-sm text-stone-700 shadow-sm focus:border-red-400 focus:outline-none focus:ring-2 focus:ring-red-100" />
                        <button type="button" data-search-clear class="absolute inset-y-0 right-3 hidden items-center justify-center text-stone-500 transition hover:text-red-600">
                ...
                <div class="grid gap-4 lg:grid-cols-2">
                    <div class="min-w-[180px] w-full">
                        ...
                        <div class="relative" data-dropdown data-dropdown-name="sort">
                            ...
                            <ul data-dropdown-list class="hidden absolute left-0 right-0 mt-2 z-50 max-h-60 overflow-auto rounded-xl border bg-white shadow-sm">
                                <li data-dropdown-option data-value="popular" class="px-3 py-2 cursor-pointer">Terlaris</li>
                                <li data-dropdown-option data-value="name_asc" class="px-3 py-2 cursor-pointer">A-Z</li>
                                <li data-dropdown-option data-value="name_desc" class="px-3 py-2 cursor-pointer">Z-A</li>
                                <li data-dropdown-option data-value="price_asc" class="px-3 py-2 cursor-pointer">Termurah</li>
                                <li data-dropdown-option data-value="price_desc" class="px-3 py-2 cursor-pointer">Termahal</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="min-w-[220px] w-full">
                        ...
                        <div class="relative" data-dropdown data-dropdown-name="category">
                            ...
                            <ul data-dropdown-list class="hidden absolute left-0 right-0 mt-2 z-50 max-h-60 overflow-auto rounded-xl border bg-white shadow-sm">
                                <li data-dropdown-option data-value="" class="px-3 py-2 cursor-pointer">Semua Kategori</li>
                                <?php foreach ($categories as $category): ?>
                                    <li data-dropdown-option data-value="<?= esc($category['id']) ?>" class="px-3 py-2 cursor-pointer"><?= esc($category['name']) ?></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
